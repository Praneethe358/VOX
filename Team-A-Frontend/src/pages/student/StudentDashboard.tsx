  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-950 to-slate-900">
      ...
      <main className="max-w-7xl mx-auto px-4 py-8">
        ...
        >
          <h3 className="text-lg font-bold text-blue-400 mb-2">💡 Need Help?</h3>
          <p className="text-blue-300 text-sm">
            Make sure your microphone and camera are properly connected before starting an exam.
            For technical support, contact <strong>support@voicesecure.edu</strong>.
          </p>
        </motion.div>
      </main>
    </div>
